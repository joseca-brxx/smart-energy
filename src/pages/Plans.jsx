...
export default function Plans() {
  ...
  function abrirWhatsapp(plan) {
    ...
    const precio = cfg.plans[plan].precio
    const mensaje = `Hola, ya pagué el plan ${nombrePlan} (${cfg.currency} ${precio}/mes) de Smart Energy con la cuenta ${user?.email || ''}. Les envío el comprobante.`
